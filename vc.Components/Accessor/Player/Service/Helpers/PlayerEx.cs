...
namespace vc.Components.Accessor.Player.Service.Helpers
{
	internal static class PlayerEx
	{
		...
		public static Interface.Player Convert(this Resource.DataSource.Model.Player source)
		{
		...
		public static Resource.DataSource.Model.Player Convert(this Interface.Player source)
		{
			var target = new Resource.DataSource.Model.Player
			{
				GamePiece = source.GamePiece,
				Id = source.Id,
				IsMachine = source.IsMachine,
